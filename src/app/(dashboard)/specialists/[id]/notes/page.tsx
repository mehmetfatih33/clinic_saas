  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-semibold">Uzman Notları</h1>
        <Link href={`/specialists/${id}/notes/new`}>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    <div className="text-sm text-gray-600">
                      ...
                      {n.patient?.name && (
                        <span className="ml-2">Hasta: {n.patient.name}</span>
                      )}
                    </div>
                    <div>
